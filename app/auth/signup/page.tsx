...
import { Mail, Lock, User, Sparkles, ArrowLeft, Github } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Start building AI-powered portfolios</p>
        </div>
        ...
        <div className="space-y-3 mb-6">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors disabled:opacity-50"
          >
